...
export default function AuthModal({ isOpen, onClose, onAuthSuccess }: AuthModalProps) {
  ...
  const handleDetailsSubmit = (e: React.FormEvent<HTMLFormElement>) => {
    e.preventDefault()
    if (!name.trim() || !lastName.trim() || !dob || !password || !agree) return
    onClose()
    onAuthSuccess({ email: contact, name: name.trim(), lastName: lastName.trim(), dob })
  }
        ...
        <div className="grid lg:h-[560px] lg:grid-cols-[0.95fr_1.05fr]">
          <div className="relative hidden flex-col items-center justify-between overflow-hidden bg-[linear-gradient(160deg,rgba(214,169,97,0.16),rgba(248,246,242,0.6))] px-7 pb-8 pt-6 text-center sm:px-10 lg:flex lg:px-12 lg:pb-9 lg:pt-7">
            ...
            <div className="relative mx-auto flex flex-col items-center">
              <h2 className="font-heading text-4xl font-medium leading-[1.15] tracking-tight text-royal sm:text-[44px]">
                Plan your
                <br />
              ...
              <p className="mt-5 max-w-[85%] text-[15px] leading-relaxed text-secondary-text sm:max-w-[330px]">
            ...
            <div className="relative flex min-h-0 w-full flex-1 items-center justify-center">
              ...
              <img
                ...
                className="pointer-events-none relative z-10 h-auto w-auto max-w-[330px] object-contain mix-blend-multiply opacity-90 lg:max-w-[360px]"
              />
            </div>
          ...
          <div className="relative flex min-h-0 flex-col py-7 pl-7 pb-14 pt-20 sm:py-10 sm:pl-10 lg:h-[560px] lg:py-12 lg:pl-12 lg:pb-16 lg:pt-24">
            <button
              ...
              style={{ visibility: step === 'otp' ? 'visible' : 'hidden' }}
            >
              <ArrowLeft size={18} />
            </button>
            <button
              ...
              onClick={() => setStep('otp')}
              className="absolute left-4 top-4 z-10 rounded-full bg-ivory p-2 text-charcoal transition hover:bg-gold-deep hover:text-white cursor-pointer"
              style={{ visibility: step === 'details' ? 'visible' : 'hidden' }}
            >
              <ArrowLeft size={18} />
            </button>
