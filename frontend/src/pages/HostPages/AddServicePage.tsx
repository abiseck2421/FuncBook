        ...
        <section className="relative overflow-hidden bg-gradient-to-b from-ivory via-ivory to-white">
          ...
          <div className="relative z-10 w-full max-w-[min(95%,1400px)] mx-auto px-4 sm:px-6 pb-8 sm:pb-12 text-center">
            ...
            <div className="flex flex-wrap items-center justify-center gap-4 mt-10">
              ...
              <Link to="/all-services" className="inline-flex items-center gap-2 px-8 py-4 rounded-2xl bg-white text-royal font-semibold text-sm ring-1 ring-black/10 hover:ring-gold-deep hover:text-gold-deep transition-all duration-500">
                View All Services
              </Link>
            </div>
          </div>
